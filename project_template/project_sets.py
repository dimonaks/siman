...
# from header import * 
import header
from set_functions import InputSet, inherit_iset, make_sets_for_conv, init_default_sets
"""
...
acc_pack_relax  = {'PREC':'Accurate', 'ADDGRID':'.TRUE.', 'EDIFF':6e-6, 'EDIFFG':-0.010, 'NSW':50, 'ISTART':1, 'ICHARG':0 }
acc_pack2_stat   = {'PREC':'Accurate', 'ADDGRID':'.TRUE.', 'EDIFF':1e-8, 'LREAL':False, 'NSW':0, 'ISTART':1, 'ICHARG':0 }
acc_pack2_relax  = {'PREC':'Accurate', 'ADDGRID':'.TRUE.', 'EDIFF':1e-8, 'LREAL':False, 'EDIFFG':-0.025, 'NSW':50, 'ISTART':1, 'ICHARG':0 }
