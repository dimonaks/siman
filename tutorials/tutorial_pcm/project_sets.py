...
mag_packet = {
    ...
    'ISPIN':2,
    'LORBIT':11, #more info
    'magnetic_moments':{'Ti':0.6, 'V':5, 'Fe':5, 'Co':0, 'Mn':5, 'Ni':5, 'Cr':5 }
...
user_vasp_sets = [
('sp', 'static', {'NPAR':None,'ISTART':None,'NELM':None,'PREC':None,'ALGO':None,'KGAMMA':None
                         ,'ENCUT':300,'SIGMA':None,'LPLANE':None}),

('opt', 'sp', {'ISIF':2, 'NSW':20, 'IBRION':1, 'EDIFFG':-0.025}, over),


('u_opt', 'opt', {**dftu_packet, 'POTIM':0.2, 'NELM':20, 'EDIFFG':-0.05, 'NSW':50, 'ISMEAR':0, 'ENCUT':400, 'ENAUG':400*1.75}, over),
('um_opt', 'u_opt', mag_packet, over    ),
('um_opt_suf', 'um_opt', surface_pack, over ),




#For PCM
('pcm_suf' ,  'um_opt_suf',  {'PREC': 'Accurate', 'NELM':400, 'EDIFF':1e-6, 'ENCUT':600, 'savefile':'ocvwl', 'LVTOT':'.TRUE.', 'LWAVE':'TRUE','set_potential':{3:"Li_sv2"}, 'LDIPOL' :None}, over), 
('pcm_bulk' , 'um_opt', {'PREC': 'Accurate', 'NELM':400, 'EDIFF':1e-6, 'ENCUT':600, 'savefile':'ocvl',  'LVTOT':'.TRUE.', 'LWAVE':'TRUE','set_potential':{3:"Li_sv2"}}, over), 
('pcm_suf_ec',   'pcm_suf', {'ISTART': 1, 'LSOL':'TRUE', 'EB_K':89.78, 'NSW':None, 'NELM':300, 'savefile':'ocvl'}, over), 
