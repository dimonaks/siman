#!/bin/bash   
#SBATCH -J LCO.104.ifn.occ.pcm_suf
#SBATCH -t 72:00:00
#SBATCH -N 1
#SBATCH -n 16
#SBATCH -o /home/a.boev//LCO//LCO.104.ifn.occ.pcm_suf/sbatch.out
#SBATCH -e /home/a.boev//LCO//LCO.104.ifn.occ.pcm_suf/sbatch.err
#SBATCH -p AMG-medium
