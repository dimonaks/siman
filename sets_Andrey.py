...
def update_sets(varset):
    ...
    s.set_dilatmx(1.05)
    s.set_tsmear(0.2)
    s.set_add_nbands(1.25) #just to check; the problem was not in bands but in parallelization
    ...
    s.set_potential(23,"potpaw_PBE_MPIE/V_sv_new")
