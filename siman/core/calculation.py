...
from siman.core.cluster_batch_script import write_body, write_footer
        ...
        for k, curset in enumerate(sets):
            ...
            if mode == "body":
                ...
                contcar_file = write_body(self, version = str(version), savefile = savefile, 
                    ...
                    input_geofile = input_geofile, parrallel_run_command = parrallel_run_command)
                ...
                contcar_file, subfolders = write_footer(self, set_mod = set_mod, run_tool_flag = run_tool_flag, savefile = savefile,
                 final_analysis_flag = final_analysis_flag, neb_flag = neb_flag, f = f)
