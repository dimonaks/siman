...
class MP_Compound():
    ...
    def calc_suf(self, ise = '9sm', bulk_cl_name = None,  it_folder = 'bulk/', status = 'create', suf_list = None, 
            min_slab_size = 12, only_stoich = 1, symmetrize = True, corenum = 4, cluster = 'cee', conv = 1, create = 1, reset_old = 0, suffix = None):
        from siman.header import db
    ...
    def calc_suf_stoich(self, ise = '9sm', bulk_cl_name = None,  it_folder = 'bulk/', status = 'create', suf_list = None, 
    ...
    def add_relax(self, ise, status = 0):
        from siman.header import db
        from siman.analysis import suf_en
    ...
    def move_suf_en(self, only_show = 1):
        from siman.header import db
